...
class AppConfig {
  ...
  // Player Discovery V2 is the default ranking pipeline. Set to false only
  // during rollback; the repository will then use the legacy V1 feed.
  static bool get playerDiscoveryV2 =>
      (dotenv.env['PLAYER_DISCOVERY_V2'] ?? 'true').toLowerCase() == 'true';
